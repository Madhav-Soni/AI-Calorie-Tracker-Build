...
const s = StyleSheet.create({
  ...
  previewTitle: { color: "#fff", fontSize: 22, fontWeight: "800", letterSpacing: 0, marginBottom: 6 },
  previewSub: { color: "rgba(255,255,255,0.45)", fontSize: 13, lineHeight: 19, marginBottom: 24 },
  analyseBtn: { backgroundColor: "#7c3aed", borderRadius: 50, paddingVertical: 16, alignItems: "center", marginBottom: 12, shadowColor: "#7c3aed", shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.22, shadowRadius: 14 },
  ...
  loadingTitle: { color: "#fff", fontSize: 20, fontWeight: "800", letterSpacing: 0 },
