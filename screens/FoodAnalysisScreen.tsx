...
const styles = StyleSheet.create({
  ...
  totalCard: { flex: 1.4, backgroundColor: "#7c3aed", borderRadius: 16, padding: 14, alignItems: "center", justifyContent: "center", shadowColor: "#7c3aed", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.4, shadowRadius: 8, elevation: 6 },
  ...
  macroCard: { flex: 1, backgroundColor: "#0f0f1a", borderRadius: 16, padding: 12, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "rgba(124, 58, 237, 0.15)" },
  ...
  foodCard: { backgroundColor: "#0f0f1a", borderRadius: 16, padding: 16, marginBottom: 10, borderWidth: 1, borderColor: "rgba(124, 58, 237, 0.12)" },
