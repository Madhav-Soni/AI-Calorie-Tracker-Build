...
const styles = StyleSheet.create({
  ...
  sheet: { flex: 1, backgroundColor: "#050510", borderTopLeftRadius: 24, borderTopRightRadius: 24, marginTop: -20 },
  ...
  totalCard: { flex: 1.4, backgroundColor: "#7c3aed", borderRadius: 22, padding: 14, alignItems: "center", justifyContent: "center", shadowColor: "#7c3aed", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.4, shadowRadius: 8, elevation: 6 },
  totalValue: { color: "#fff", fontSize: 28, fontWeight: "800" },
  totalLabel: { color: "rgba(255,255,255,0.8)", fontSize: 11, fontWeight: "600", letterSpacing: 1 },
  macroCard: { flex: 1, backgroundColor: "#0D0D1A", borderRadius: 22, padding: 12, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "rgba(127, 119, 221, 0.18)" },
  ...
  sectionTitle: { color: "rgba(255,255,255,0.5)", fontSize: 10, fontWeight: "700", letterSpacing: 2, textTransform: "uppercase", marginBottom: 12 },
  foodCard: { backgroundColor: "#0D0D1A", borderRadius: 22, padding: 16, marginBottom: 10, borderWidth: 1, borderColor: "rgba(127, 119, 221, 0.18)" },
  ...
  logBtn: { backgroundColor: "#7c3aed", borderRadius: 50, paddingVertical: 16, alignItems: "center", marginTop: 24, shadowColor: "#7c3aed", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.4, shadowRadius: 12, elevation: 6 },
